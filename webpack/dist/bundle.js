...
var greetings = function greetings(text, person) {
    return text + ", " + person + ". I read you but i'm sorry.";
};
...
module.exports = {"container":"index__container___298WH","element":"index__element___1qCp9"};
